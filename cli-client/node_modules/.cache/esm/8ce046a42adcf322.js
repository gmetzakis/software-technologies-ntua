let axios,type;_2ad‍.x([["SessionsPerPoint",()=>SessionsPerPoint]]);_2ad‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_2ad‍.w("os",[["type",["type"],function(v){type=v}]]);

var fs = require('fs'); 

       async function SessionsPerPoint(args){
    ...
    function request(url, path){
        ...
        function get_request(err, data){
            ...
            .then(response => {
                _2ad‍.g.console.log(response.data[0])
            })
            .catch((error) => {
                _2ad‍.g.console.log("Error", error.response.status)
                _2ad‍.g.console.log(error.response.data.message)
            })
        })
    }
