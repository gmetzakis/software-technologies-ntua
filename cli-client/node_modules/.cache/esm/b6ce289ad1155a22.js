let axios,type;_d11‍.x([["SessionsPerProvider",()=>SessionsPerProvider]]);_d11‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_d11‍.w("os",[["type",["type"],function(v){type=v}]]);

var fs = require('fs'); 

       async function SessionsPerProvider(args){
    ...
    function request(url, path){
        ...
        function get_request(err, data){
            ...
            .then(response => {
                _d11‍.g.console.log(response.data)
            })
            .catch((error) => {
                _d11‍.g.console.log("Error", error.response.status)
                _d11‍.g.console.log(error.response.data.message)
            })
        })
    }
