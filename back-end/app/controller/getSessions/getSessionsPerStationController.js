...
var get_SessionsPerStation = require('../../model/getSessions/getSessionsPerStationModel.js');
var authenticate = require('../../auth/auth.js');

const checks = require("../utils.js");

exports.get_sessions_per_station = function(req, res){
  var year_from;
  var month_from;
  var day_from;
  var year_to;
  ...
  if(!(req.params.stationID && req.params.date_from && req.params.date_to)){
  ...
  else if(req.params.stationID.length>255 || req.params.length > 255){
    ...
    authenticate(req, function(err2, res2, usr2, per){
      if(err2){
        ...
        get_SessionsPerStation(req.params.stationID,year_from,month_from,day_from,year_to,month_to,day_to,dateTime,function(err3, res3){
          if(err3){
